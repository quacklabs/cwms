<div class="card-body">
    <form action="{{ route('access.modifyByRole', ['role' => 'staff']) }}" method="POST">
        @csrf
            ...
            <div class="col-sm-8">
                ...
                <div class="form-check">
                    ...
                    <input name="{{ $user_permission->name }}" class="form-check-input" type="checkbox"
                        @if($staff_role->hasPermissionTo($user_permission->name))
                            checked
                        @endif
                    >
            ...
            <div class="col-sm-8">
                ...
                <div class="form-check">
                    ...
                    <input name="{{ $store_permission->name }}" class="form-check-input" type="checkbox"
                        @if($staff_role->hasPermissionTo($store_permission->name))
                            checked
                        @endif
                    >
                    <label class="form-check-label" for="gridCheck1">
            ...
            <div class="col-sm-8">
                ...
                <div class="form-check">
                    ...
                    <input name="{{ $warehouse_permission->name }}" class="form-check-input" type="checkbox"
                        @if($staff_role->hasPermissionTo($warehouse_permission->name))
                            checked
                        @endif
                    >
                    <label class="form-check-label" for="gridCheck1">
            ...
            <div class="col-sm-8">
                ...
                <div class="form-check">
                    ...
                    <input name="{{ $product_permission->name }}"  class="form-check-input" type="checkbox"
                        @if($staff_role->hasPermissionTo($product_permission->name))
                            checked
                        @endif
                    >
                    <label class="form-check-label" for="gridCheck1">

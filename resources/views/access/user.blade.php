<div class="card-body">
    <form action="{{ route('access.byUser', ['id' => $staff->id]) }}" method="POST">
        @csrf
            ...
            <div class="col-sm-8">
                ...
                <div class="form-check">
                    ...
                    <input name="{{ $user_permission->name }}" class="form-check-input" type="checkbox"
                        @if($staff->hasPermissionTo($user_permission->name))
                            checked
                        @endif
                    >
            ...
            <div class="col-sm-8">
                ...
                <div class="form-check">
                    ...
                    <input name="{{ $store_permission->name }}" class="form-check-input" type="checkbox"
                        @if($staff->hasPermissionTo($store_permission->name))
                            checked
                        @endif
                    >
                    <label class="form-check-label" for="gridCheck1">
            ...
            <div class="col-sm-8">
                ...
                <div class="form-check">
                    ...
                    <input name="{{ $warehouse_permission->name }}" class="form-check-input" type="checkbox"
                        @if($staff->hasPermissionTo($warehouse_permission->name))
                            checked
                        @endif
                    >
                    <label class="form-check-label" for="gridCheck1">
            ...
            <div class="col-sm-8">
                ...
                <div class="form-check">
                    ...
                    <input name="{{ $product_permission->name }}"  class="form-check-input" type="checkbox"
                        @if($staff->hasPermissionTo($product_permission->name))
                            checked
                        @endif
                    >
                    <label class="form-check-label" for="gridCheck1">

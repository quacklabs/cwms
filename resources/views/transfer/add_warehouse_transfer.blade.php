...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">New Transfer From Warehouse</h2>
                            ...
                            <div class="col-12">
                                <div class="tab-content no-padding" id="myTab2Content">
                                    <div class="tab-pane fade active show" id="home4" role="tabpanel" aria-labelledby="home-tab4">
                                        <form id="storeOrderForm" action="{{ route('transfer.makeTransfer', ['flag' => 'warehouse', 'destination' => 'store']) }}" method="POST">
                                            @csrf
                                    ...
                                    <div class="tab-pane fade" id="profile4" role="tabpanel" aria-labelledby="home-tab4">
                                        <form id="warehouseOrderForm" action="{{ route('transfer.makeTransfer', ['flag' => 'warehouse', 'destination' => 'warehouse']) }}" method="POST">
                                            @csrf

        ...
        <div class="row mt-4">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="orderForm" action="{{ route('sale.create', ['flag' => $flag]) }}" method="POST">
                            @csrf
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    <label for="inputPassword4">{{ ucwords($flag) }}</label>
                                    <div class="form-control p-0">
                                        <select data-name="{{ $flag }}" name="location_id" class="p-0 mb-0 selector warehouse_select" required>
                                            <option value=""></option>
                                            @empty($warehouses)
...
<script>
    ...
    const product_options = {
        ...
        load: function(query, callback) {
            ...
            const partner_id = $("#partner_select").val()
            const warehouse_id = $("#warehouse_select").val()
            const url = "{{ route('api.findProductByWarehouse', ['id' => $user->hasRole('admin') ? '0' : $user->warehouse->id]) }}"

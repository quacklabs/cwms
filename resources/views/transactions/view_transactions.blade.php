                                            ...
                                            <td>
                                                <div class="buttons">
                                                    ...
                                                    @can('create-purchase-return')
                                                        <a href="#" data-toggle="modal" data-target="#myModal" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="" data-original-title="{{ ($flag == 'purchase') ? 'Return Purchase' : 'Return Sale' }}">
